...
export default async function OperationsLayout({ children }: { children: ReactNode }) {
  ...
  const navigation = [
    { href: "/operations", label: "Overview", allowed: hasPermission(roles, "dashboard.view") },
    ...
    { href: "/operations/fulfillment", label: "Fulfillment", allowed: hasPermission(roles, "fulfillment.view") },
    { href: "/operations/admin/users", label: "Users", allowed: hasPermission(roles, "admin.manage") },
    { href: "/operations/admin/m2m", label: "M2M STAGING", allowed: hasPermission(roles, "m2m.approve") },
